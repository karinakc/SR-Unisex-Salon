...
const TestimonialsSection = () => {
  ...
  return (
    <section
      id="testimonials"
      className="relative py-24 md:py-32 overflow-hidden bg-[linear-gradient(170deg,#17181c_0%,#22252b_46%,#1a1d23_100%)]"
    >
      ...
      <div className="container relative z-10 mx-auto px-4 md:px-8">
        <div ref={ref} className={`text-center mb-16 transition-all duration-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="inline-block mt-5 font-body text-xs tracking-[0.22em] uppercase text-primary hover:text-gold-light transition-colors"
          >
            View All Reviews
          </a>
        </div>
      ...
      <div
        ref={scrollRef}
        className="relative z-10 flex gap-6 overflow-hidden px-4"
